...
public class BlockFire extends Block {
    ...
    public void a(World world, int i, int j, int k, Random random) {
        ...
        } else if (!this.ba(world, i, j - 1, k) && l == 15 && random.nextInt(4) == 0) {
            world.d(i, j, k, 0);
        } else {
            if (l % 2 == 0 && l > 2) {
    ...
    private boolean g(World world, int i, int j, int k) {
        return this.ba(world, i + 1, j, k) ? true : (this.ba(world, i - 1, j, k) ? true : (this.ba(world, i, j - 1, k) ? true : (this.ba(world, i, j + 1, k) ? true : (this.ba(world, i, j, k - 1) ? true : this.ba(world, i, j, k + 1)))));
    }
    ...
    public boolean ba(IBlockAccess iblockaccess, int i, int j, int k) {
