...
public class MinecraftServer implements ICommandListener, Runnable {
    ...
    private boolean d() throws UnknownHostException {
        ...
        ConsoleLogManager.a();
        a.info("Starting minecraft server version 0.2.1b (Bukkit Alpha 1.1.2)");
    ...
    private void c(String s) {
        ...
        this.e = new WorldServer(this, new File("."), s, this.d.a("monsters", false));
            ...
            if (!s.toLowerCase().startsWith("help") && !s.toLowerCase().startsWith("?")) {
                if (s.toLowerCase().startsWith("list")) {
                    ...
                    if (s.toLowerCase().startsWith("op ")) {
                        ...
                        if (s.toLowerCase().startsWith("health")) {
                        	entityplayer = this.f.h(s1);
                        	int h1 = entityplayer.aM;
                        	this.f.a(entityplayer.aq, (Packet) (new Packet3Chat("Your health: \u00A7c" + Integer.toString(h1))));
