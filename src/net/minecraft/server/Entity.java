...
public abstract class Entity {
    ...
    public int Y;
    private boolean ad;
    public double ae; // ALPHACRAFT
    private double af;
    public boolean Z;
    public int aa;
    public int ab;
    public int ac;
    protected boolean adNew; // ALPHACRAFT
    ...
    // TODO, useful method to find a lot of corresponding fields
    public void v() {
        if (this.g.B) {
            this.g = null;
        } else {
    ...
    public void e(Entity entity) {
        ...
        if (entity == null) {
            if (this.g != null) {
                this.c(this.g.l, this.g.v.b + (double) this.g.E, this.g.n, this.r, this.s);
                this.g.f = null;
            }
